...
<div class="play-container">
    <div class="map-container">
        ...
        <div id="map-container">
            ...
            <div class="line-text" id="chiffre-Foulestaque-Apex" style="top: calc((150px + 185px) / 2); left: calc((85px + 218px) / 2);">4</div>
            ...
            <div class="line-text" id="chiffre-Kotlin-Rust" style="top: calc((510px + 611px) / 2); left: calc((30px + 177px) / 2);">5</div>
            ...
            <div class="line-text" id="chiffre-Rust-Scala" style="top: calc((611px + 622px) / 2); left: calc((177px + 370px) / 2);">6</div>
            ...
            <div class="line-text" id="chiffre-Kotlin-Python" style="top: calc((510px + 345px) / 2); left: calc((30px + 125px) / 2);">7</div>
            ...
            <div class="line-text" id="chiffre-Kotlin-Crystal" style="top: calc((510px + 551px) / 2); left: calc((30px + 175px) / 2);">8</div>
            ...
            <div class="line-text" id="chiffre-Crystal-Scala" style="top: calc((551px + 622px) / 2); left: calc((175px + 370px) / 2);">9</div>
            ...
            <div class="line-text" id="chiffre-Python-Swift" style="top: calc((345px + 437px) / 2); left: calc((125px + 318px) / 2);">10</div>
            ...
            <div class="line-text" id="chiffre-Swift-Toniz" style="top: calc((439px + 500px) / 2); left: calc((320px + 515px) / 2);">11</div>
            ...
            <div class="line-text" id="chiffre-Swift-Falcon" style="top: calc((439px + 421px) / 2); left: calc((320px + 519px) / 2);">12</div>
            ...
            <div class="line-text" id="chiffre-Falcon-Ariana" style="top: calc((421px + 357px) / 2); left: calc((519px + 655px) / 2);">13</div>
            ...
            <div class="line-text" id="chiffre-Ariana-Elixir" style="top: calc((357px + 330px) / 2); left: calc((655px + 822px) / 2);">14</div>
            ...
            <div class="line-text" id="chiffre-Scala-Perl" style="top: calc((622px + 590px) / 2); left: calc((370px + 510px) / 2);">15</div>
            ...
            <div class="line-text" id="chiffre-Toniz-Perl" style="top: calc((500px + 590px) / 2); left: calc((515px + 510px) / 2);">16</div>
            ...
            <div class="line-text" id="chiffre-Perl-Lua" style="top: calc((590px + 625px) / 2); left: calc((510px + 587px) / 2);">17</div>
            ...
            <div class="line-text" id="chiffre-Falcon-Prolog" style="top: calc((421px + 275px) / 2); left: calc((519px + 552px) / 2);">18</div>
            ...
            <div class="line-text" id="chiffre-Python-Apex" style="top: calc((345px + 185px) / 2); left: calc((125px + 218px) / 2);">19</div>
            ...
            <div class="line-text" id="chiffre-Python-Ruby" style="top: calc((345px + 275px) / 2); left: calc((125px + 62px) / 2);">20</div>
            ...
            <div class="line-text" id="chiffre-Foulestaque-Ruby" style="top: calc((150px + 275px) / 2); left: calc((85px + 62px) / 2);">21</div>
            ...
            <div class="line-text" id="chiffre-Foulestaque-Java" style="top: calc((150px + 50px) / 2); left: calc((85px + 240px) / 2);">22</div>
            ...
            <div class="line-text" id="chiffre-Kotlin-Ruby" style="top: calc((510px + 275px) / 2); left: calc((30px + 62px) / 2);">23</div>
            ...
            <div class="line-text" id="chiffre-Java-Pascal" style="top: calc((50px + 207px) / 2); left: calc((240px + 382px) / 2);">24</div>
            ...
            <div class="line-text" id="chiffre-Apex-Pascal" style="top: calc((185px + 207px) / 2); left: calc((218px + 382px) / 2);">25</div>
            ...
            <div class="line-text" id="chiffre-Pascal-Prolog" style="top: calc((207px + 275px) / 2); left: calc((382px + 552px) / 2 );">26</div>
            ...
            <div class="line-text" id="chiffre-Lua-Lisp" style="top: calc((631px + 578px) / 2); left: calc((595px + 720px) / 2);">27</div>
            ...
            <div class="line-text" id="chiffre-Lisp-Dart" style="top: calc((578px + 350px) / 2); left: calc((720px + 908px) / 2);">28</div>
            ...
            <div class="line-text" id="chiffre-Lisp-Elm" style="top: calc((578px + 580px) / 2); left: calc((715px + 932px) / 2);">29</div>
            ...
            <div class="line-text" id="chiffre-Dart-Elixir" style="top: calc((350px + 330px) / 2); left: calc((908px + 822px) / 2);">30</div>
            ...
            <div class="line-text" id="chiffre-Dart-Groovy" style="top: calc((350px + 282px) / 2); left: calc((908px + 912px) / 2);">31</div>
            ...
            <div class="line-text" id="chiffre-Dart-Elm" style="top: calc((350px + 588px) / 2); left: calc((908px + 920px) / 2);">32</div>
            ...
            <div class="line-text" id="chiffre-Groovy-Templake" style="top: calc((282px + 240px) / 2); left: calc((912px + 778px) / 2);">33</div>
            ...
            <div class="line-text" id="chiffre-Groovy-Julia" style="top: calc((282px + 230px) / 2); left: calc((912px + 1153px) / 2);">34</div>
            ...
            <div class="line-text" id="chiffre-Templake-Elixir" style="top: calc((240px + 330px) / 2); left: calc((778px + 822px) / 2);">35</div>
            ...
            <div class="line-text" id="chiffre-Templake-Fortran" style="top: calc((210px + 145px) / 2); left: calc((770px + 877px) / 2);">36</div>
            ...
            <div class="line-text" id="chiffre-Templake-Laraville" style="top: calc((145px + 163px) / 2); left: calc((877px + 620px) / 2);">37</div>
            ...
            <div class="line-text" id="chiffre-Fortran-Groovy" style="top: calc((145px + 282px) / 2); left: calc((877px + 912px) / 2);">38</div>
            ...
            <div class="line-text" id="chiffre-Assembly-Pascal" style="top: calc((41px + 207px) / 2); left: calc((413px + 382px) / 2);">39</div>
            ...
            <div class="line-text" id="chiffre-Pascal-Delphi" style="top: calc((207px + 143px) / 2); left: calc((382px + 460px) / 2);">40</div>

            <button class="line-button" id="milieu-Delphi-Haskell1" style="top: calc((133px + 158px) / 2); left: calc((460px + 608px) / 2); background-color: var(--color-chemin-vert);"></button>
            <div class="line-text" id="chiffre-Delphi-Haskell1" style="top: calc((133px + 158px) / 2); left: calc((460px + 608px) / 2);">41</div>

            <button class="line-button" id="milieu-Delphi-Haskell2" style="top: calc((76px + 158px) / 2); left: calc((745px + 608px) / 2); background-color: var(--color-chemin-vert);"></button>
            <div class="line-text" id="chiffre-Delphi-Haskell2" style="top: calc((76px + 158px) / 2); left: calc((745px + 608px) / 2);">42</div>
            ...
            <div class="line-text" id="chiffre-Haskell-Prolog" style="top: calc((158px + 283px) / 2); left: calc((608px + 530px) / 2);">43</div>
            ...
            <div class="line-text" id="chiffre-Prolog-Ariana" style="top: calc((275px + 357px) / 2); left: calc((552px + 655px) / 2);">44</div>
            ...
            <div class="line-text" id="chiffre-Prolog-Laraville" style="top: calc((285px + 76px) / 2); left: calc((542px + 745px) / 2);">45</div>
            ...
            <div class="line-text" id="chiffre-Laraville-Fortran" style="top: calc((76px + 135px) / 2); left: calc((745px + 865px) / 2);">46</div>
            ...
            <div class="line-text" id="chiffre-Fortran-Ada" style="top: calc((135px + 69px) / 2); left: calc((865px + 1100px) / 2);">47</div>
            ...
            <div class="line-text" id="chiffre-Ada-Groovy" style="top: calc((69px + 270px) / 2); left: calc((1100px + 912px) / 2);">48</div>
            ...
            <div class="line-text" id="chiffre-Ada-Cobol" style="top: calc((69px + 150px) / 2); left: calc((1100px + 1140px) / 2);">49</div>
            ...
            <div class="line-text" id="chiffre-Cobol-Julia" style="top: calc((150px + 227px) / 2); left: calc((1140px + 1153px) / 2);">50</div>
            ...
            <div class="line-text" id="chiffre-Julia-Erlang" style="top: calc((227px + 545px) / 2); left: calc((1153px + 1105px) / 2);">51</div>
            ...
            <div class="line-text" id="chiffre-Erlang-Elm" style="top: calc((545px + 580px) / 2); left: calc((1105px + 932px) / 2);">52</div>
            ...
            <div class="line-text" id="chiffre-Assembly-Delphi" style="top: calc((41px + 133px) / 2); left: calc((413px + 460px) / 2);">52</div>
